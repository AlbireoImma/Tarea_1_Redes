...
!! Para definir la IP del server usamos make dir='IP' IP el: make dir='10.0.0.1' IP SOLO FUNCIONA una vez uso de sed para cambiar localhost, se puede usar nuevamente pero se debe cambiar la IP usada actualmente ver Makefile
